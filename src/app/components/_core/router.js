...
var NotImplemeneted = require('../gameobject/detail-pages/404-page');

module.exports = router.extend({
  routes: {
    'static/BCM.html?home': 'home',
    'static/BCM.html?console': 'console',
    'static/BCM.html?players/online': 'playersOnline',
    'static/BCM.html?players/all': 'playersAll',
    'static/BCM.html?player/:steamId': 'notimplemented',
    'static/BCM.html?entities/enemies': 'entities',
    'static/BCM.html?entity/:entityid': 'notimplemented',
    'static/BCM.html?gameobjects': 'gameobjects',
    'static/BCM.html?gameobjects/archetypes': 'archetypes',
    'static/BCM.html?gameobject/archetype/:name': 'notimplemented',
    'static/BCM.html?gameobjects/biomes': 'biomes',
    'static/BCM.html?gameobject/biome/:name': 'notimplemented',
    'static/BCM.html?gameobjects/biomespawning': 'biomespawning',
    'static/BCM.html?gameobject/biomespawn/:name': 'notimplemented',
    'static/BCM.html?gameobjects/blocks': 'blocks',
    'static/BCM.html?gameobject/block/:name': 'notimplemented',
    'static/BCM.html?gameobjects/buffs': 'buffs',
    'static/BCM.html?gameobject/buff/:name': 'notimplemented',
    'static/BCM.html?gameobjects/entityclasses': 'entityclasses',
    'static/BCM.html?gameobject/entityclass/:name': 'notimplemented',
    'static/BCM.html?gameobjects/entitygroups': 'entitygroups',
    'static/BCM.html?gameobject/entitygroup/:name': 'notimplemented',
    'static/BCM.html?gameobjects/itemclasses': 'itemclasses',
    'static/BCM.html?gameobject/itemclass/:name': 'notimplemented',
    'static/BCM.html?gameobjects/items': 'items',
    'static/BCM.html?gameobject/item/:name': 'notimplemented',
    'static/BCM.html?gameobjects/lootcos': 'lootcos',
    'static/BCM.html?gameobject/lootco/:name': 'notimplemented',
    'static/BCM.html?gameobjects/lootgrs': 'lootgrs',
    'static/BCM.html?gameobject/lootgr/:name': 'notimplemented',
    'static/BCM.html?gameobjects/lootqts': 'lootqts',
    'static/BCM.html?gameobject/lootqt/:name': 'notimplemented',
    'static/BCM.html?gameobjects/lootpts': 'lootpts',
    'static/BCM.html?gameobject/lootpt/:name': 'notimplemented',
    'static/BCM.html?gameobjects/materials': 'materials',
    'static/BCM.html?gameobject/material/:name': 'notimplemented',
    'static/BCM.html?gameobjects/prefabs': 'prefabs',
    'static/BCM.html?gameobject/prefab/:name': 'notimplemented',
    'static/BCM.html?gameobjects/quests': 'quests',
    'static/BCM.html?gameobject/quest/:name': 'notimplemented',
    'static/BCM.html?gameobjects/recipes': 'recipes',
    'static/BCM.html?gameobject/recipe/:name': 'notimplemented',
    'static/BCM.html?gameobjects/rwgs': 'rwgs',
    'static/BCM.html?gameobject/rwg/:name': 'notimplemented',
    'static/BCM.html?gameobjects/skills': 'skills',
    'static/BCM.html?gameobject/skill/:name': 'notimplemented',
    'static/BCM.html?gameobjects/spawners': 'spawners',
    'static/BCM.html?gameobject/spawner/:name': 'notimplemented',
  ...
  notimplemented: function () { app.trigger('page', new NotImplemeneted({ model: app.me })); },
