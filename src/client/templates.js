(function (root, factory) {
    ...
    templatizer["includes"]["player"] = function tmpl_includes_player() {
        return '<div class="col-xs-12 player"><div class="col-md-6 player-name"><div><div><a data-hook="name" class="name-link"> </a></div><div><span class="entityid">&#40;<a data-hook="entityid" title="click to copy to clipboard" class="hoverlink"></a>&#41;</span>&#32;<span class="steamid">&#40;<a data-hook="steamid" title="click to copy to clipboard" class="hoverlink"></a>&#41;</span></div></div><div><div class="div-inline"><div class="div-inline"><div><span class="stat-health pad-left-10">H:</span><span data-hook="health"></span><span>/</span><span data-hook="wellness"></span></div><div class="stat-bar bar-bg"><div data-hook="health-bar" class="stat-bar bar-health"></div></div></div><div class="div-inline"><div><span class="stat-stamina pad-left-10">S:</span><span data-hook="stamina"></span><span>/</span><span data-hook="wellness"></span></div><div class="stat-bar bar-bg"><div data-hook="stamina-bar" class="stat-bar bar-stamina"></div></div></div></div><div class="div-inline"><div class="div-inline"><div><span class="stat-food pad-left-10">F:</span><span data-hook="food"></span><span>/100</span></div><div class="stat-bar bar-bg"><div data-hook="food-bar" class="stat-bar bar-food"></div></div></div><div class="div-inline"><div><span class="stat-drink pad-left-10">D:</span><span data-hook="drink"></span><span>/100</span></div><div class="stat-bar bar-bg"><div data-hook="drink-bar" class="stat-bar bar-drink"></div></div></div></div></div><div><span class="position"><a data-hook="copypos" title="click to copy to clipboard" class="hoverlink">&#64;</a><span>&#32;</span><span data-hook="position"></span><span style="color:#428bca;">&#32;&#32;&#8635;&#32;</span><span data-hook="rotangle"></span><span>&#0176;</span><span style="color:#428bca;">&#32;&#32;&#8737;&#32;</span><span data-hook="viewangle"></span></span><span class="coretemp">T:<span data-hook="coretemp"></span><span>&#8457;</span></span><span data-hook="isalive" class="life-symbol"></span></div></div><div class="col-md-6 player-details"><div><div><div class="col-xs-6"><span>Gamestage: </span></div><div class="col-xs-6 text-right"><span data-hook="gamestage"></span></div></div><div><div class="col-xs-6"><span>Score: </span></div><div class="col-xs-6 text-right"><span data-hook="score"></span></div></div><div><div class="col-xs-6"><span>Player Kills: </span></div><div class="col-xs-6 text-right"><span data-hook="pkill"></span></div></div><div><div class="col-xs-6"><span>Zombie Kills: </span></div><div class="col-xs-6 text-right"><span data-hook="zkill"></span></div></div><div><div class="col-xs-6"><span>Deaths: </span></div><div class="col-xs-6 text-right"><span data-hook="deaths"></span></div></div><div><div class="col-xs-6"><span>Current Life: </span></div><div class="col-xs-6 text-right"><span data-hook="current"></span></div></div><div><div class="col-xs-6"><span>Longest Life: </span></div><div class="col-xs-6 text-right"><span data-hook="longest"></span></div></div><div><div class="col-xs-6"><span>Level: </span></div><div class="col-xs-6 text-right"><span data-hook="level"> </span> &#40;+<span data-hook="progress"></span>&#37;&#41;</div></div><div><div class="col-xs-6"><span>XP Progress: </span></div><div class="col-xs-6 text-right"><span data-hook="expprogress"></span></div></div><div><div class="col-xs-6"><span>Craft Count: </span></div><div class="col-xs-6 text-right"><span data-hook="crafted"></span></div></div><div><div class="col-xs-6"><span>Walked: </span></div><div class="col-xs-6 text-right"><span data-hook="walked"></span></div></div><div><div class="col-xs-6"><span>Speed: </span></div><div class="col-xs-6 text-right"><span data-hook="speed"></span></div></div><div><div class="col-xs-4"><div>Ip: </div></div><div class="col-xs-8 text-right"><div><span data-hook="ip"></span></div></div></div><div><div class="col-xs-4"><div>Session: </div></div><div class="col-xs-8 text-right"><div><span data-hook="session"></span></div></div></div><div><div class="col-xs-4"><div>PlayTime: </div></div><div class="col-xs-8 text-right"><div><span data-hook="playtime"></span></div></div></div><div><div class="col-xs-4"><div>Ping: </div></div><div class="col-xs-8 text-right"><div><span data-hook="ping"></span></div></div></div><div><div class="col-xs-4"><div>LastOnline: </div></div><div class="col-xs-8 text-right"><div><span data-hook="online"></span></div></div></div></div></div></div>';
    };
    ...
    templatizer["pages"]["login"] = function tmpl_pages_login() {
        return '<section class="page login"><h2>Admin Token Credentials</h2><p data-hook="credentials"></p><form data-hook="login-form"><fieldset data-hook="field-container"></fieldset><div class="buttons"><button data-hook="login" type="submit" class="btn">Submit</button></div></form><br/><div data-hook="steam-login"><span>Steam Login comming soon...</span></div></section>';
    };
